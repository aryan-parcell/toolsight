    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-4xl font-black text-axiom-headingLight dark:text-white">Reports</h2>
                    <p className="text-axiom-textLight dark:text-axiom-textDark">View organizational reports.</p>
                </div>
            </div>
